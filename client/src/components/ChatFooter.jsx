...
export default function ChatFooter({sendingMsg , setSendingMsg,sendMsg}) {
  // console.log("from footer",sendingMsg)
  const sendOnClick = (e) =>{
    e.preventDefault();
    // console.log("send on CLiek was called")
    // setSendingMsg(sendingMsg);
    sendMsg(sendingMsg);
    setSendingMsg("")
  }
  return (
    <>
      <div className="flex flex-row items-center h-16 rounded-xl bg-white w-full px-4">
        ...
        <form className="flex w-full items-center" onSubmit={(e)=>{sendOnClick(e)}}>
